    ...
    while True:
        ...
        if "Help" in command:
            ...
            if message == None:
                ...
                path_taken = maze_runner.maze_run(cells_ref,exits,obstacle,current_cell,[],420,220,10,direction,turtle.Turtle(),x,y,degree)

                # path_taken = maze_runner.maze_runner(cells_ref,exits,obstacle,current_cell,[],408,208,4,"south",turtle.Turtle(),x,y,degree)
